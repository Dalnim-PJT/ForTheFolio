    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('github', models.URLField()),
                ('introduction', models.TextField()),
                ('like_users', models.ManyToManyField(related_name='like_portfolios', to=settings.AUTH_USER_MODEL)),
                ('stack', models.ManyToManyField(related_name='portfolio_stacks', to='portfolios.TechStack')),
                ('tempalte', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='portfolios.p_templates')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('portfolio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='portfolios.portfolios')),
        ...
        migrations.AddField(
            ...
            name='stack',
            field=models.ManyToManyField(related_name='template_stacks', to='portfolios.TechStack'),
        ),
        migrations.CreateModel(
            name='Career',
            fields=[
